...
?par #allow define grafical parameters
par()
par('pch') #allow check the default values
par('lty') #allow check the default values

x = 2:4
plot(x, pch = "c") #pch is the grafical element inside the plot
